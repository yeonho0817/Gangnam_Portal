...
public class EmployeeCustomRepositoryImpl implements EmployeeCustomRepository {
    ...
    @Override
    public List<EmployeeDTO.HRInfo> readHumanResource(Pageable pageable, String selectValue, String searchText) {
        // selectValue = 이름, 직급, 소속
        // searchText = 검색어
        
        // 이메일 id 젤 빠른거 한개만
        return jpaQueryFactory.select(Projections.fields(EmployeeDTO.HRInfo.class,
                        qEmployee.id.as("employeeId"),
                        qEmployee.nameKr.as("nameKr"),
    ...
    @Override
    public List<EmployeeDTO.HRDepartmentInfo> readHumanResourceDepartment(Pageable pageable, String name, String affiliation, String department) {

        return jpaQueryFactory.select(Projections.fields(EmployeeDTO.HRDepartmentInfo.class,
                        qEmployee.id.as("employeeId"),
                        qEmployee.nameKr.as("nameKr"),
                        qRanks.name.as("rank"),
                        qAffiliation.name.as("affiliation"),
